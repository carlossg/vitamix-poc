...
| Worker | URL | Purpose |
|--------|-----|---------|
| **vitamix-recommender** | `vitamix-recommender.paolo-moz.workers.dev` | Main AI generation pipeline with Claude + Cerebras |
| **vitamix-analytics** | `vitamix-analytics.paolo-moz.workers.dev` | Event aggregation, multi-agent analysis |
