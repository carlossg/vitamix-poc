...
exports.onRecipeUpload = onRecipeUpload;
exports.generateRecipeEmbeddings = generateRecipeEmbeddings;
...
function getFirestore() {
    if (!_firestore)
        _firestore = new firestore_1.Firestore(getProjectId() ? { projectId: getProjectId() } : undefined);
    return _firestore;
}
...
// ============================================
async function onRecipeUpload(cloudEvent) {
    ...
    try {
        ...
        const recipe = JSON.parse(contents.toString());
...
// ============================================
async function generateRecipeEmbeddings(req, res) {
    try {
 ...
 */
async function generateEmbedding(recipe) {
...
async function generateTextEmbedding(text) {
    try {
        ...
        const embedding = result.response.embedding?.values || [];
